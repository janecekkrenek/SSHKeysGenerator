...
namespace Krenek.SSHKeysGenerator.Generators
{
    ...
    /// ECDsa Cipher
    /// </summary>
    public class ECDsaGenerator : GenericGenerator
    {
        #region Instances
        /// <summary>
        /// Curve
        ...
        public ECDsaGenerator(ECCurve curve)
        {
            _curve = curve;
        ...
        public ECDsaGenerator(string curveName)
        {
        ...
        public ECDsaGenerator(ECCurve curve, string comment)
        {
            _curve = curve;
            _key = ECDsa.Create(curve);
        ...
        /// <param name="curveName">Curve name</param>
        /// <param name="comment">Comment</param>
        public ECDsaGenerator(string curveName, string comment)
        {
            _curve = ECCurve.CreateFromFriendlyName(curveName);
            if (curveName.Contains("nistP"))
                _isAllowedConvertToPuTTY = true;
